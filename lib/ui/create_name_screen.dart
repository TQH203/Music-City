...
class CreateNameScreen extends StatefulWidget {
  const CreateNameScreen({super.key, required String email, required String password, required String gender});
          ...
          child: Column(
            ...
            children: [
              ...
              const Row(
                children: [
                  Text(
                    "This appears on your Music City profile",
                    style: TextStyle(
                      fontFamily: "AM",
                      fontSize: 10,
                      color: MyColors.whiteColor,
              ...
              Row(
                children: [
                  const Text(
                    "Please send me news and offers from Music City.",
                    style: TextStyle(
                      fontFamily: "AM",
                      fontSize: 12,
                      color: MyColors.whiteColor,
              ...
              Row(
                children: [
                  const SizedBox(
                    width: 290,
                    child: Text(
                      "Share my registration data with Music City's content providers for marketing purposes.",
                      style: TextStyle(
                        fontFamily: "AM",
                        fontSize: 12,
                        color: MyColors.whiteColor,
